...
tags: [tâche, phase-1, identité, authentik]

outils: [Authentik, Docker]
...
- [ ] Configurer Provider OIDC pour Cloudflare Access — voir [[Phase 1 - Fédération OIDC Entra]]
- [ ] Configurer Provider SAML pour Entra ID — voir [[Phase 1 - Fédération OIDC Entra]]
