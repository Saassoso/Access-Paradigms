...
Aucun port n'est ouvert en entrée. [[../20 - Outils/Cloudflare]] Tunnel expose les services via une connexion sortante depuis le Docker Host. Voir [[Zero Trust Tunnel]].
