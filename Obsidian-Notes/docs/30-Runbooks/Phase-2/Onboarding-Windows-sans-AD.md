...
- [x] Compte Action1 créé 
- [x] Groupe "Onboarding" configuré dans Action1 avec les scripts
- [x] Entra ID App Registration pour la source OIDC → [[Phase 1 - Fédération OIDC Entra]]
