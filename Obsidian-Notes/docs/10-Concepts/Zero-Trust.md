...
1. **Identity** — [[keycloak] + [[Entra ID]] + Cloudflare Access
2. **Device** — [[Action1]] + [[Wazuh]] SCA + Sysmon
3. **Network** — [[../20 - Outils/OPNsense Configuration]] VLANs + [[Zero Trust Tunnel]]
4. **Application** — Cloudflare Access (edge) + keycloak Outpost (interne)
